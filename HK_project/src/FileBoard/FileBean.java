...
public class FileBean {
	...
	private String fileName; // 업로드 할 파일명
	...
	public String toString() {
		return "NoticeBean [num=" + num + ", name=" + name + ", subject=" + subject + ", content=" + content
				+ ", readcount=" + readcount + ", writedate=" + writedate + ", re_ref=" + re_ref + ", re_lev=" + re_lev
				+ ", re_seq=" + re_seq + ", ip=" + ip + ", fileName=" + fileName + ", fileRealName=" + fileRealName
				+ "]";
	}
}
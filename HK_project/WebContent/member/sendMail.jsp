...
<html>
  ...
  <body>
    ...
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand">Email 문의</a>
        </div>
      </div>
    </div>
    <!--// 상단 고정메뉴 (검정) -->
    ...
    <div class="container">
      ...
      <form class="form-horizontal" method="post" action="sendMailPro.jsp">
        <fieldset>
          <legend>
            <strong>메일작성</strong>
          </legend>
          ...
          <div class="form-group">
            <label class="control-label col-sm-2" for="sender">보내는 주소 <font color='red'>*</font></label>
            <div class="col-sm-10">
          ...
          <div class="form-group" hidden="hidden">
            <label class="control-label col-sm-2" for="receiver">받는 주소 <font color='red'>*</font></label>
            <div class="col-sm-10">
              <input type="text" name="receiver" id="receiver" class="form-control" value="gyrud13@naver.com" />
            </div>
          </div>
